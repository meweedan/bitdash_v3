                ...
                <Box p={4} bg={isDark ? `brand.${platformKey}.900` : `brand.${platformKey}.50`} borderRadius="md">
                  ...
                  <Text mt={2}>
                    {t(`${platformKey}SpecificRisk.content`, {
                      ...
                      tazdani: 'Payment processing services involve risks related to compliance, fraud, and operational issues. Merchants and agents face additional risks related to chargebacks, regulatory requirements, and handling of client funds.'
