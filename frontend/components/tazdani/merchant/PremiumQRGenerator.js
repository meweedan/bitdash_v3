// components/tazdani/merchant/PremiumQRGenerator.js
...
const PremiumQRGenerator = ({ 
  ...
  const qrStyles = {
    default: {
      bgColor: '#FFFFFF',
      fgColor: '#1179BE',
      logoImage: '/images/tazdani-logo.png'
    },
    premium: {
      bgColor: '#000000',
      fgColor: '#FFFFFF',
      logoImage: '/images/tazdani-logo-white.png'
    },
    modern: {
      bgColor: '#1A1A1A',
      fgColor: '#00F6FF',
      logoImage: '/images/tazdani-logo-blue.png'
    }
  };
  ...
  const handleCopyLink = () => {
    const paymentUrl = `https://tazdani.bitdash.app/pay/${merchantData.id}`;
  ...
  const QRDisplay = () => (
    ...
    >
      ...
      >
        <QRCode
          value={`https://tazdani.bitdash.app/pay/${merchantData.id}`}
          size={300}
          level="H"
              ...
              <TabPanel>
                <VStack spacing={6} align="stretch">
                  ...
                  <FormControl display="flex" alignItems="center">
                    <FormLabel mb={0}>Show tazdani Logo</FormLabel>
                    <Switch
                      isChecked={showLogo}
                  ...
                  >
                    <VStack align="stretch" spacing={4}>
                      ...
                      <UnorderedList>
                        ...
                        <ListItem>tazdani Stickers</ListItem>
