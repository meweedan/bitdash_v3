// components/tazdani/merchant/BusinessDetailsCard.js
...
const BusinessDetailsCard = ({ merchant, onQROpen, onCreateLink }) => {
  ...
  const bgGradient = useColorModeValue(
    'linear(to-r, tazdani.400, tazdani.700)',
    'linear(to-r, tazdani.600, tazdani.800)'
  );
          ...
          <HStack spacing={6} align="start" flexWrap={{ base: "wrap", md: "nowrap" }}>
            ...
            <VStack align="stretch" spacing={4} flex={1}>
              <VStack align="stretch" spacing={1}>
                <Heading size="lg" color="tazdani.500">
