      ...
      <Container maxW="8xl" px={{ base: 4, lg: 0 }}>
        ...
        <VStack spacing={16} py={28} align="center">
          <VStack textAlign="center" maxW="3xl" spacing={6}>
            <Heading
              ...
              bgClip="text"
            >
              {t('solutions.title', 'Enterprise Solutions')}
            </Heading>
            <Text
              fontSize="xl"
              color={useColorModeValue('gray.600', 'gray.300')}
            >
              {t('solutions.subtitle', 'Powerful tools for businesses of all sizes')}
            </Text>
          </VStack>
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <VStack spacing={6} align="start">
                  <Icon as={solution.icon} boxSize={12} color={solution.color} />
                  <Heading size="md">{t(solution.title, 'Solution')}</Heading>
                  <Text>{t(solution.description, 'Solution description')}</Text>
                  <Code
                    colorScheme="green"
                    p={4}
                    borderRadius="xl"
                    ...
                    w="full"
                  >
                    {t(solution.technical, 'Technical details')}
                  </Code>
                </VStack>
              </Box>
            ))}
        ...
        <Box py={20}>
          ...
          >
            <VStack spacing={8}>
              <Heading size="xl">
                {t('cta.title', 'Ready to Transform Your Payments?')}
              </Heading>
              <Text fontSize="xl" maxW="2xl">
                {t('cta.description', 'Join thousands of businesses and millions of users on the fastest growing payment network')}
              </Text>
              <Button
                size="lg"
                colorScheme="green"
