...
const BitCashLanding = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      color: 'brand.adfaaly.600'
    },
    {
      icon: FaMobileAlt,
      title: 'mobile.app.title',
      description: 'mobile.app.description',
      color: 'brand.adfaaly.700'
    }
  ];
          ...
          >
            <VStack spacing={8} maxW="4xl">
              <Heading
                ...
                bgGradient="linear(to-r, brand.adfaaly.500, brand.adfaaly.700)"
                bgClip="text"
              >
            ...
            >
              <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
                <VStack
                  ...
                  spacing={4}
                >
                  <Icon as={FaBolt} boxSize={8} color="brand.adfaaly.500" />
                  <Text fontWeight="bold">{t('demo.instant_transfer', 'Transfer Speed')}</Text>
                  <Text fontSize="3xl" fontWeight="bold" color="brand.adfaaly.500">
                    &lt; 1s
                  </Text>
                </VStack>
                <VStack
                  ...
                  spacing={4}
                >
                  <Icon as={FaGlobe} boxSize={8} color="brand.adfaaly.500" />
                ...
                <VStack
                  ...
                  spacing={4}
                >
                  <Icon as={FaStore} boxSize={8} color="brand.adfaaly.500" />
