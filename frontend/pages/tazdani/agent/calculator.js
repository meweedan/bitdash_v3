          ...
          <SlideFade in offsetY="20px">
            <VStack spacing={4} textAlign="center" mb={10}>
              <Heading 
                ...
                color={accentColor}
              >
                {t('calculator.heading', 'tazdani Agent Earnings Calculator')}
              </Heading>
              <Text fontSize={{ base: 'md', md: 'lg' }} maxW="800px">
                {t('calculator.subheading', 'Estimate your potential income as a tazdani agent based on transaction volume and type')}
              </Text>
            </VStack>
          </SlideFade>
