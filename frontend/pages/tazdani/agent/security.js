          ...
          <SlideFade in offsetY="20px">
            <VStack spacing={4} textAlign="center" mb={10}>
              ...
              <Heading 
                ...
                color={accentColor}
              >
                {t('security.heading', 'tazdani Agent Network Security Protocols')}
              </Heading>
                ...
                <TabPanels>
                  ...
                  <TabPanel>
                    <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} alignItems="center">
                      <Box>
                        ...
                        <Text mb={4}>
                          {t('security.blockchain.intro', 'tazdani leverages secure blockchain technology to create a transparent, immutable record of all transactions processed through our agent network.')}
                        </Text>
                  ...
                  <TabPanel>
                    <VStack spacing={6} align="stretch">
                      ...
                      <Text mb={4}>
                        {t('security.fraud.intro', 'tazdani maintains a zero-tolerance policy for fraudulent activities with a multi-layered approach to detect, prevent, and address potential threats.')}
                      </Text>
            ...
            >
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} alignItems="center">
                <Box>
                  ...
                  <Text mb={4}>
                    {t('security.compliance.intro', 'tazdani maintains strict adherence to all applicable financial regulations, AML policies, and industry standards.')}
                  </Text>
          ...
          <SlideFade in offsetY="30px">
            ...
            >
              ...
              <Text maxW="2xl" mx="auto" mb={6}>
                {t('security.cta.description', 'tazdani is committed to maintaining the highest standards of security, integrity, and compliance across our agent network. Our multi-layered approach protects agents, customers, and the overall financial ecosystem.')}
              </Text>
              <Button 
