...
// Agent Components
import AgentHeader from '@/components/tazdani/agent/AgentHeader';
import AgentMetrics from '@/components/tazdani/agent/AgentMetrics';
import CashBalanceWidget from '@/components/tazdani/agent/CashBalanceWidget';
import DailyLimitTracker from '@/components/tazdani/agent/DailyLimitTracker';
import LocationManager from '@/components/tazdani/agent/LocationManager';
...
const AgentDashboard = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Agent Dashboard | tazdani</title>
      </Head>
