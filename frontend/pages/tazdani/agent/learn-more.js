...
function LearnMore() {
  ...
  const accentBg = useColorModeValue('brand.tazdani.50', 'brand.tazdani.900');
  ...
  const successStories = [
    {
      ...
      content: t('learnMore.success.story1.content', 'I added tazdani services to my pharmacy business and now earn an additional $850 per month in commissions. More importantly, the increased foot traffic has boosted my retail sales by 22%.'),
    ...
    },
    {
      ...
      content: t('learnMore.success.story2.content', 'Starting as a tazdani agent was the perfect opportunity after university. I now process over 200 transactions weekly and have built a thriving business serving my local area.'),
    ...
    },
    {
      ...
      content: t('learnMore.success.story3.content', 'My small store now serves as an essential financial hub for the neighborhood. The tazdani agent program was easy to join, and the ongoing support has been excellent throughout my journey.'),
  ...
  const faqItems = [
    ...
    {
      question: t('learnMore.faq.q4', 'What ongoing support does tazdani provide?'),
      answer: t('learnMore.faq.a4', 'tazdani provides comprehensive support including dedicated agent managers, 24/7 technical assistance, marketing materials, training updates, and access to our agent community forum for best practices sharing.'),
    },
    {
      question: t('learnMore.faq.q5', 'How do I manage my operating float?'),
      answer: t('learnMore.faq.a5', 'Your float is managed through the tazdani agent portal where you can monitor balances, request top-ups, and set automated alerts. We also offer float advance options for qualified agents during high-volume periods.'),
    },
  ];
          ...
          <SlideFade in offsetY="20px">
            <VStack spacing={4} textAlign="center" mb={10}>
              ...
              <Heading 
                ...
                color={accentColor}
              >
                {t('learnMore.heading', 'Learn More About Becoming a tazdani Agent')}
              </Heading>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8}>
                <Box>
                  <Heading size="lg" mb={4} color={accentColor}>
                    {t('learnMore.value.heading', 'Why Become a tazdani Agent?')}
                  </Heading>
                    ...
                    <ListItem>
                      <HStack alignItems="start">
                        ...
                        <Box>
                          ...
                          <Text fontSize="sm">
                            {t('learnMore.value.point2.description', 'For existing businesses, tazdani services bring new customers to your location who often make additional purchases, increasing overall revenue by 15-30%.')}
                          </Text>
                        </Box>
                      </HStack>
                    </ListItem>
                ...
                <Image 
                  ...
                  alt={t('learnMore.value.imageAlt', 'tazdani agent serving customer')}
                  fallback={
                    <Box 
                      bg="brand.cash.400" 
                      width="100%" 
          ...
          <SlideFade in offsetY="30px">
            ...
            >
              ...
              <Text textAlign="center" mb={8} maxW="3xl" mx="auto">
                {t('learnMore.requirements.description', 'tazdani maintains high standards for our agent network to ensure security and quality service. Here\'s what you need to qualify:')}
              </Text>
          ...
          <SlideFade in offsetY="30px">
            ...
            >
              <Heading size="lg" mb={6} color={accentColor} textAlign="center">
                {t('learnMore.journey.heading', 'The tazdani Agent Journey')}
              </Heading>
          ...
          <SlideFade in offsetY="30px">
            ...
            >
              <Heading size="lg" mb={4}>
                {t('learnMore.cta.heading', 'Ready to Start Your tazdani Agent Journey?')}
              </Heading>
