...
const getFAQData = (t) => [
  {
    question: t('merchants.faq.q1', 'How do I sign up as a tazdani merchant?'),
  ...
  },
  {
    ...
    answer: t('merchants.faq.a2', 'tazdani merchants enjoy competitive transaction fees of just 1.5% per successful payment. There are no monthly fees, no setup costs, and no hidden charges. You only pay when you get paid.'),
  },
  {
    question: t('merchants.faq.q3', 'How quickly will I receive payments?'),
    answer: t('merchants.faq.a3', 'All payments are settled instantly to your tazdani merchant wallet. You can withdraw funds at any time to your bank account, use them for business expenses via the tazdani app, or collect cash at any of our agent locations.'),
  },
  {
    question: t('merchants.faq.q4', 'Can I use tazdani for both online and in-person sales?'),
  ...
  },
  {
    ...
    answer: t('merchants.faq.a6', 'Customers can pay using the tazdani app by scanning your QR code, clicking your payment link, or finding your business in the merchant directory. They can fund payments from their tazdani balance, linked bank accounts, or cards.'),
  },
  {
  ...
  },
  {
    ...
    answer: t('merchants.faq.a8', 'We offer comprehensive API documentation for integrating tazdani payments into your website or app. Our developer support team is available to help with technical questions and implementation guidance.'),
  },
];
            ...
            >
              <VStack spacing={{ base: 4, md: 8 }} maxW="4xl">
                <Heading
                  ...
                  lineHeight="1.2"
                >
                  {t('merchants.hero.heading', 'Grow Your Business with tazdani Payments')}
                </Heading>
                <Text fontSize={{ base: 'lg', md: 'xl' }} opacity={0.8} maxW="3xl">
                  {t('merchants.hero.subtext', 'Accept payments online or in person, get paid instantly, and manage your cash flow with ease. Join thousands of merchants transforming their businesses with tazdani.')}
                </Text>
          ...
          <SlideFade in offsetY="30px">
            <Box mt={sectionPadding} p={{ base: 6, md: 10 }} bg={cardBg} borderRadius="xl" boxShadow="xl">
              ...
              <Text fontSize={{ base: 'md', md: 'lg' }} mb={6}>
                {t('merchants.benefits.subtext', 'tazdani gives merchants powerful, flexible payment solutions with the lowest fees in the industry. Whether you run an online store, a physical shop, or provide services, we\'ve got you covered.')}
              </Text>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} mb={6}>
                <VStack align="start" spacing={4}>
                  ...
                  <Text fontSize="sm">
                    {t('merchants.benefits.feature2.description', 'No more waiting days for payments to clear. Receive funds instantly in your tazdani wallet and access your money immediately.')}
                  </Text>
                </VStack>
              ...
              >
                <Heading size="md" mb={3} color="brand.cash.500">
                  {t('merchants.benefits.whyChoose.heading', 'Why Businesses Choose tazdani')}
                </Heading>
                <List spacing={3}>
                  <ListItem>
          ...
          <SlideFade in offsetY="30px">
            <Box mt={sectionPadding} p={{ base: 6, md: 10 }} bg={cardBg} borderRadius="xl" boxShadow="xl">
              ...
              >
                ...
                <Text mb={4}>
                  Seamlessly integrate tazdani into your existing business systems:
                </Text>
          ...
          <SlideFade in offsetY="30px">
            <Box mt={sectionPadding} p={{ base: 6, md: 10 }} bg={cardBg} borderRadius="xl" boxShadow="xl">
              ...
              <Text fontSize={{ base: 'md', md: 'lg' }} textAlign="center" mb={8}>
                From small shops to large enterprises, businesses of all sizes trust tazdani for reliable payment processing.
              </Text>
            </Box>
          </SlideFade>
            ...
            >
              <VStack spacing={{ base: 4, md: 6 }}>
                ...
                <Text fontSize={{ base: 'md', md: 'lg' }} maxW="2xl">
                  {t('merchants.cta.subtext', 'Join thousands of successful merchants using tazdani to streamline payments, increase sales, and simplify financial management.')}
                </Text>
                <HStack spacing={4}>
                  <Button
                    rightIcon={<ArrowForwardIcon />}
