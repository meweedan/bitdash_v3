...
// Components
import TransactionsList from '@/components/tazdani/merchant/TransactionsList';
import PaymentLinksList from '@/components/tazdani/merchant/PaymentLinksList';
import WalletBalance from '@/components/tazdani/WalletBalance';
import PaymentLinkGenerator from '@/components/tazdani/merchant/PaymentLinkGenerator';
...
const MerchantDashboard = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>{merchant.businessName || 'Merchant'} Dashboard | tazdani</title>
      </Head>
