...
function MerchantDemo() {
  ...
  const generatePaymentLink = () => {
    ...
    setTimeout(() => {
      ...
      const link = `https://tazdani.bitdash.app/${mockId}`;
      setPaymentLink(link);
          ...
          <SlideFade in offsetY="20px">
            <VStack spacing={4} textAlign="center" mb={10}>
              <Heading 
                ...
                color={accentColor}
              >
                {t('merchantDemo.heading', 'See How tazdani Works for Merchants')}
              </Heading>
                      ...
                      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
                        ...
                        >
                          ...
                          <VStack align="start" spacing={3}>
                            ...
                            <HStack>
                              <CheckCircleIcon color="green.500" />
                              <Text fontSize="sm">{t('merchantDemo.step1.benefits.benefit2', 'Get paid instantly to your tazdani wallet')}</Text>
                            </HStack>
                            <HStack>
                              <CheckCircleIcon color="green.500" />
                        ...
                        <VStack align="stretch" spacing={4}>
                          ...
                          <FormControl>
                            ...
                            <Select defaultValue="instant">
                              <option value="instant">Instant to tazdani Wallet</option>
                        ...
                        <VStack spacing={4} align="center">
                          ...
                          >
                            <Box bg="brand.cash.500" p={3}>
                              <Text fontWeight="bold" textAlign="center">tazdani Payment</Text>
                            </Box>
                            <VStack p={4} spacing={4}>
                              ...
                              <Text fontSize="xs" color="gray.500" textAlign="center">
                                {t('merchantDemo.step4.preview.secureNote', 'Secure payment powered by tazdani')}
                              </Text>
                            </VStack>
                          </Box>
                    ...
                    <TabPanel>
                      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
                        ...
                        >
                          ...
                          <Text fontSize="sm">
                            {t('merchantDemo.info.benefits.benefit1.description', 'Receive payments instantly in your tazdani wallet, with no processing delays or pending periods.')}
                          </Text>
                        </Box>
                    ...
                    <TabPanel>
                      <Accordion allowToggle>
                        <AccordionItem mb={3} border="none" borderRadius="md" overflow="hidden" boxShadow="sm">
                          ...
                          <AccordionPanel>
                            {t('merchantDemo.info.faq.a1', 'All payments are settled instantly to your tazdani wallet. You can withdraw funds to your bank account (1-2 business days) or collect cash immediately at any tazdani agent location.')}
                          </AccordionPanel>
                        </AccordionItem>
                        ...
                        <AccordionItem mb={3} border="none" borderRadius="md" overflow="hidden" boxShadow="sm">
                          ...
                          <AccordionPanel>
                            {t('merchantDemo.info.faq.a2', 'No, tazdani does not charge any monthly fees, setup fees, or hidden costs. You only pay a 1.5% transaction fee when you receive a payment.')}
                          </AccordionPanel>
                        </AccordionItem>
                        ...
                        <AccordionItem mb={3} border="none" borderRadius="md" overflow="hidden" boxShadow="sm">
                          ...
                          <AccordionPanel>
                            {t('merchantDemo.info.faq.a4', 'Yes, tazdani offers a robust API with documentation and SDKs for major programming languages. Our team can also assist with integration if needed.')}
                          </AccordionPanel>
                        </AccordionItem>
                      </Accordion>
                    </TabPanel>
            ...
            <SlideFade in offsetY="30px">
              ...
              >
                ...
                <Text maxW="2xl" mx="auto" mb={6}>
                  {t('merchantDemo.cta.description', 'Join thousands of businesses using tazdani to accept payments, increase sales, and simplify financial management.')}
                </Text>
