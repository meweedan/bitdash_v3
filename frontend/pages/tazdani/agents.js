...
const getAgentFAQData = (t) => [
  {
    question: t('agents.faq.q1', 'What is required to become a tazdani agent?'),
    answer: t('agents.faq.a1', 'To become a tazdani agent, you need: 1) A registered business with physical location or verification as an individual agent, 2) Valid identification documents, 3) Proof of address, 4) Completion of our compliance training, and 5) Initial operating float. Our thorough verification process ensures network security.'),
  },
  {
    question: t('agents.faq.q2', 'How does tazdani ensure security for agents and customers?'),
    answer: t('agents.faq.a2', 'tazdani employs blockchain technology for transaction verification and immutable record-keeping. All agents undergo thorough verification, regular audits, and ongoing compliance monitoring. Our platform features real-time fraud detection, transaction limits, two-factor authentication, and 24/7 security monitoring to protect both agents and customers.'),
  },
  {
    question: t('agents.faq.q3', 'What are the income opportunities for tazdani agents?'),
    answer: t('agents.faq.a3', 'tazdani agents earn through multiple revenue streams: 1) Transaction commissions (1.2% on cash deposits, 0.8% on withdrawals), 2) New customer referral bonuses, 3) Volume-based monthly incentives, and 4) Special promotions. High-performing agents can earn $500-$3,000 monthly depending on location, transaction volume, and agent tier level.'),
  },
  {
              ...
              <SlideFade in offsetY="20px">
                <VStack spacing={6} align={locale === 'ar' ? 'end' : 'start'} textAlign={locale === 'ar' ? 'right' : 'left'}>
                  ...
                  <Text fontSize={{ base: 'lg', md: 'xl' }} maxW="600px">
                    {t('agents.hero.subtext', 'Join the tazdani Agent Network to offer essential financial services from your location. Create new revenue streams while helping your community access digital finance.')}
                  </Text>
              ...
              <SlideFade in offsetY="20px" delay={0.2}>
                ...
                >
                  <Image 
                    ...
                    alt={t('agents.hero.image.alt', 'tazdani agent serving a customer')} 
                    fallback={
                      <Box 
                        bg="brand.cash.400" 
                        width="100%" 
                      ...
                      >
                        <Text fontWeight="bold">
                          {t('agents.hero.image.placeholder', 'tazdani Agent Network')}
                        </Text>
                      </Box>
                    }
                    objectFit="cover"
        ...
        <Container maxW="7xl" py={16}>
          ...
          <SlideFade in offsetY="30px">
            <VStack textAlign="center" spacing={4} mb={12}>
              ...
              >
                {t('agents.valueProp.heading', 'The tazdani Agent Network Advantage')}
              </Heading>
            ...
            <Box mb={16}>
              <VStack textAlign="center" spacing={4} mb={8}>
                <Heading 
                  ...
                  color="brand.cash.400"
                >
                  {t('agents.howItWorks.heading', 'How the tazdani Agent Network Works')}
                </Heading>
                <Text fontSize={{ base: 'lg', md: 'xl' }} maxW="800px">
                  ...
                  <TabPanel>
                    <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8}>
                      ...
                      >
                        ...
                        <Text textAlign="center">
                          {t('agents.howItWorks.agents.step2.description', 'Process deposit, withdrawal, or merchant settlement request through the tazdani Agent app.')}
                        </Text>
                      </VStack>
                  ...
                  <TabPanel>
                    <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8}>
                      ...
                      >
                        ...
                        <Text textAlign="center">
                          {t('agents.howItWorks.customers.step1.description', 'Find the nearest tazdani agent via the app map or look for the tazdani logo at local businesses.')}
                        </Text>
                      </VStack>
  ...
  >
    <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} alignItems="center">
      <Box>
        ...
        <Button variant="tazdani-outline" onClick={() => router.push('/agent/calculator')}>
    ...
    >
      <GridItem colSpan={{ base: 1, lg: 1 }}>
        ...
        >
          ...
          <Text>
            {t('agents.security.description', 'At tazdani, security and compliance are non-negotiable. Our comprehensive approach combines advanced technology with strict policies to ensure the integrity of our agent network.')}
          </Text>
          <Button 
            mt={6} 
        ...
        >
          ...
          >
            ...
            <Text fontSize="sm" color="red.800">
              {t('agents.security.zeroTolerance.description', 'tazdani maintains a zero-tolerance policy for fraudulent or malicious activities. Any agent found engaging in suspicious behavior will be immediately suspended pending investigation, with permanent removal and possible legal action for confirmed violations.')}
            </Text>
          </Box>
        </Box>
      </GridItem>
    ...
    <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
      ...
      >
        ...
        <Text fontStyle="italic" mb={4}>
          {t('agents.testimonials.testimonial1.content', '"The tazdani platform has transformed my grocery store. We now serve 30-40 financial transactions daily, earning additional income while bringing in new customers who often purchase from our store as well."')}
        </Text>
        <HStack mt={6}>
          <Box 
            w={12} 
      ...
      >
        ...
        <Text fontStyle="italic" mb={4}>
          {t('agents.testimonials.testimonial3.content', '"As a young entrepreneur, becoming a tazdani agent has given me a stable income and respect in my community. The training was excellent, and the app makes transactions simple. I am earning about $900 monthly in commissions."')}
        </Text>
        <HStack mt={6}>
          <Box 
            w={12} 
  ...
  >
    ...
    <VStack spacing={6} position="relative" zIndex={2}>
      <Heading 
        ...
        textAlign="center"
      >
        {t('agents.cta.heading', 'Join the tazdani Agent Network Today')}
      </Heading>
      <Text 
        fontSize={{ base: 'md', md: 'lg' }} 
        textAlign="center"
      ...
      >
        ...
        >
          <Text fontWeight="bold" fontSize="lg">
            {t('agents.cta.option1.title', 'Become a tazdani Agent')}
          </Text>
