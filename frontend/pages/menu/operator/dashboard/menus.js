  ...
  return (
    <Box>
      <Flex justifyContent="space-between" alignItems="center" mb={4}>
        ...
        <Button onClick={() => router.push('/menu/operator/dashboard/menus/create')} colorScheme="green">
          Add Menu
        </Button>
      </Flex>
          ...
          {menus.map((menu) => (
            <Box key={menu.id} p={4} borderWidth="1px" borderRadius="md">
              <Flex justify="space-between">
                ...
                <Flex gap={2}>
                  <Button colorScheme="blue" size="xs" onClick={() => router.push(`/menu/operator/dashboard/menus/edit?id=${menu.id}`)}>Edit</Button>
