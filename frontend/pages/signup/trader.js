...
export default function TraderSignup() {
  ...
  const renderAccountStep = () => (
    <VStack spacing={6} align="stretch">
      ...
      <Alert status="info" borderRadius="md">
        <AlertIcon />
        <Text fontSize="sm" color="linear(to-r, brand.adfaaly.500, brand.adfaaly.700)">
      ...
      <Box pt={4}>
        <Button
          color="brand.adfaaly.400"
          variant="adfaaly-outline"
          size="lg"
          onClick={nextStep}
          width="full"
        >
  ...
  const renderTradingStep = () => (
    <VStack spacing={6} align="stretch">
        ...
        >
          <Stack direction="column" spacing={3}>
            {ACCOUNT_TYPES.map(type => (
              ...
              >
                <Radio value={type.value} color="brand.adfaaly.400">
        ...
        >
          <Stack direction="column" spacing={2}>
            {TRADING_EXPERIENCE_OPTIONS.map(option => (
              <Radio key={option.value} value={option.value} color="brand.adfaaly.400">
                {option.label}
              </Radio>
            ))}
          </Stack>
      ...
      <FormControl>
        ...
        >
          <Stack direction="column" spacing={2}>
            <Radio value="rarely" color="brand.adfaaly.400">{t('rarely')}</Radio>
            <Radio value="occasionally" color="brand.adfaaly.400">{t('occasionally')}</Radio>
            <Radio value="frequently" color="brand.adfaaly.400">{t('frequently')}</Radio>
            <Radio value="daily" color="brand.adfaaly.400">{t('daily')}</Radio>
          </Stack>
        </RadioGroup>
      </FormControl>
      ...
      <FormControl>
        ...
        >
          <Stack direction="column" spacing={2}>
            <Radio value="conservative" color="brand.adfaaly.400">{t('conservative')}</Radio>
            <Radio value="moderate" color="brand.adfaaly.400">{t('moderate')}</Radio>
            <Radio value="aggressive" color="brand.adfaaly.400">{t('aggressive')}</Radio>
          </Stack>
        </RadioGroup>
      </FormControl>
  ...
  const accentColor = useColorModeValue('brand.adfaaly.500', 'brand.adfaaly.700');
