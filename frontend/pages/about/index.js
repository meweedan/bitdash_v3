...
const PlatformsAnimation = () => {
  ...
  const platforms = [
    { name: 'Cash', icon: FaMoneyBillWave, color: 'brand.cash.500' },
    { name: 'Crypto', icon: FaChartLine, color: 'brand.crypto.500' },
    { name: 'Stocks', icon: FaUniversity, color: 'brand.stocks.500' },
    { name: 'Forex', icon: FaExchangeAlt, color: 'brand.forex.500' }
  ];
