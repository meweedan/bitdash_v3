  ...
  const renderIdentifierStep = () => (
    <View style={styles.formContainer}>
      <View style={styles.toggleContainer}>
        ...
        >
          <Icon name="mail" size={20} color={isEmail ? theme.colors.bitcash[500] : '#666'} />
        ...
        >
          <Icon name="phone" size={20} color={!isEmail ? theme.colors.bitcash[500] : '#666'} />
          <ThemedText style={[styles.toggleText, !isEmail && styles.toggleTextActive]}>
            {t('auth.phone')}
          </ThemedText>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  toggleTextActive: {
    color: theme.colors.bitcash[500]
  },
  button: {
    backgroundColor: theme.colors.bitcash[500],
    padding: 16,
    borderRadius: 12,
    alignItems: 'center',
    marginTop: 20
