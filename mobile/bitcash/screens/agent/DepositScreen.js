...
const DepositScreen = () => {
  ...
  const handleSubmit = () => {
    ...
    depositMutation.mutate({ customerId: selectedCustomer.id, amount, customerPin });
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {selectedCustomer && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Deposit Form</Text>
          <TextInput
            style={styles.input}
          ...
          />
          <Button title="Complete Deposit" onPress={handleSubmit} />
        </View>
      )}
